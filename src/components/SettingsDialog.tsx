                          ...
                          >
                            <div className="flex justify-between items-start">
                              <div>
                                ...
                                <p className="text-sm text-gray-400">
                                  {providerRegistry.getProviderDisplayName(config.aiProvider)} • {config.model}
                                </p>
                            ...
                            {activeAIConfigId !== config.id && (
                              <button
                                ...
                                className="mt-2 px-3 py-1 text-xs font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700"
                              >
                            ...
                            {activeAIConfigId === config.id && (
                              <span className="mt-2 inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-green-100 text-green-800">
