  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-gray-800 shadow-md">
      <div className="p-4 bg-gray-900 border-b border-gray-700">
        <h2 className="text-lg font-semibold mb-4 text-gray-100">Step by step Structure View generated from user's Docs</h2>
        
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-300 mb-1">Feature:</label>
          <input
            type="text"
            value={featureName}
            readOnly
            className="w-full p-2 border border-gray-600 rounded-md bg-gray-700 text-gray-200 shadow-sm"
          />
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center mt-2">
              <input
                ...
                className="flex-1 p-2 border border-gray-600 rounded-md bg-gray-700 text-gray-200 shadow-sm focus:ring-blue-500 focus:border-blue-500"
              />
              <button
